...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ModelPopUpAjaxToolKitApp.Default" %>
...
<body>
    ...
    <asp:scriptmanager runat="server"></asp:scriptmanager>
       ...
       <asp:GridView ID="gvEmp" runat="server" BackColor="White" AutoGenerateColumns="false"
        ...
        TargetControlID="btnDummy" PopupControlID="pnlpopup"  Enabled="True"></ajaxToolkit:ModalPopupExtender>
